<template>
    <div class="disease">
        <div class="disease-title">
           ...
           <div class="table-box">
            <el-table :data="disease.slice((currentPage - 1) * pageSize, currentPage * pageSize)" border="true" stripe  style="width:100%" :row-style="tableRowStyle" :header-row-style="tableHeaderColor">
