<template>
    <div class="article">
        ...
        <el-row :gutter="20">
            <el-col
            v-for="item in article.slice((currentPage - 1) * pageSize, currentPage * pageSize)"
            :key="item._id"
            :span="24"
            @click=goToDetail(item._id)
            >
            <el-card body-style="background-color: #E6E8EB;display: flex;justify-content: space-between;align-items: center;">
                <div class="item">
                    <time>{{ item.time }}</time>
