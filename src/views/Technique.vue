<template>
    <div class="technique">
        ...
        <el-row :gutter="20">
            <el-col v-for="item in technique.slice((currentPage - 1) * pageSize, currentPage * pageSize)" :key="item._id"
                :span="24">
        ...
        <el-pagination :current-page="currentPage" v-model:page-size="pageSize" :page-sizes="[5, 10, 15, 20]" background
            layout="total, sizes, prev, pager, next, jumper" :total="technique.length" @size-change="handleSizeChange"
